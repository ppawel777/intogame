...
import { Calendar, MapPin, Star, TrendingUp, Trophy, Users } from 'lucide-react'
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               {testimonials.map((testimonial, index) => (
                  ...
                  >
                     ...
                     {/* Quote */}
                     <p className="text-foreground/90 mb-6 leading-relaxed">&ldquo;{testimonial.text}&rdquo;</p>
