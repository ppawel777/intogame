         ...
         <div className="container relative z-10 text-center px-4">
            <div className="max-w-4xl mx-auto">
               ...
               <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-muted/50 backdrop-blur-sm border border-border/50 mb-8 animate-fade-in">
                  ...
                  <span className="text-sm text-muted-foreground">Форматы 3×3, 4×4, 5×5, 6×6, 7×7 и мини-футбол</span>
               </div>
               ...
               <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-slide-up animation-delay-200">
                  Находи матчи рядом, бронируй место в один клик и играй с проверенными игроками. Создавай свои игры и
                  управляй оплатой без лишних хлопот.
               </p>

               {/* CTA Buttons */}
               <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up animation-delay-300">
                  <Button variant="hero" size="xl" onClick={handleFindGame}>
                     Найти игру
                     <Search className="ml-2 h-5 w-5" />
                  </Button>
                  <Button variant="heroOutline" size="xl" onClick={handleCreateGame}>
                     Создать матч
