import { Search, CreditCard, Play, Trophy } from "lucide-react";
      ...
      <div className="container relative">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            От поиска до игры — всего несколько минут
          </p>
        </div>
            ...
            {steps.map((step, index) => (
              <div key={index} className="flex flex-col items-center text-center group">
                ...
                <div className={`w-20 h-20 rounded-full flex items-center justify-center mb-6 transition-all duration-300 group-hover:scale-110 ${
                  ...
                  <step.icon className={`h-10 w-10 ${step.color === "primary" ? "text-primary" : "text-accent"}`} />
                </div>
