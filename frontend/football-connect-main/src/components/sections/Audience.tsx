...
import { Search, UserPlus, CreditCard, Trophy, PlusCircle, Users, Settings, Wallet } from "lucide-react";
  ...
  return (
    <div className="bg-gradient-card rounded-3xl p-8 md:p-12 border border-border/50">
      ...
      <p className="text-muted-foreground text-lg mb-8">
        Находи матчи рядом с тобой, записывайся и играй с проверенными игроками. 
        Отслеживай свою статистику и становись лучше с каждой игрой.
      </p>
...
const ForOrganizers = () => {
  ...
  return (
    <div className="bg-gradient-card rounded-3xl p-8 md:p-12 border border-accent/30">
      ...
      <p className="text-muted-foreground text-lg mb-8">
        Создавай матчи, находи игроков и управляй оплатой без лишних хлопот. 
        Все инструменты для организации игр в одном месте.
      </p>
      ...
      <Button variant="accent" className="w-full" size="xl">
        Создать игру
